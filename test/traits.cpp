...
static_assert(!http::is_server_socket<http::poly_socket_base>::value,
              "http::poly_socket_base is a server_socket?!");
static_assert(!http::is_server_socket<http::basic_poly_socket_base<int>>::value,
              "http::basic_poly_socket_base<int> is a server_socket?!");

static_assert(http::is_socket<http::poly_socket_base>::value,
              "http::poly_socket_base is not a socket?!");
static_assert(http::is_socket<http::basic_poly_socket_base<int>>::value,
              "http::basic_poly_socket_base<int> is not a socket?!");

static_assert(http::is_server_socket<http::poly_server_socket>::value,
              "http::poly_server_socket is a server_socket?!");
static_assert(http::is_server_socket<http::basic_poly_server_socket<int, int>>
              ::value,
              "http::basic_poly_server_socket<int> is not a server_socket?!");

static_assert(http::is_socket<http::poly_server_socket>::value,
              "http::poly_server_socket is not a socket?!");
