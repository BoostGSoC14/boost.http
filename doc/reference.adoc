...
* <<poly_server_socket_header,`<boost/http/poly_server_socket.hpp>`>>
* <<poly_client_socket_header,`<boost/http/poly_client_socket.hpp>`>>
* <<poly_socket_base_header,`<boost/http/poly_socket_base.hpp>`>>
* <<poly_socket_header,`<boost/http/poly_socket.hpp>`>>
* <<read_state_header,`<boost/http/read_state.hpp>`>>
* <<server_socket_adaptor_header,`<boost/http/server_socket_adaptor.hpp>`>>
* <<client_socket_adaptor_header,`<boost/http/client_socket_adaptor.hpp>`>>
* <<socket_adaptor_header,`<boost/http/socket_adaptor.hpp>`>>
...
`BOOST_HTTP_SOCKET_DEFAULT_BODY_COPY_THRESHOLD`::
  ...
  This macro defines the default value for <<basic_socket,`basic_socket`>>'s
  `Settings::body_copy_threshold`. It represents the maximum amount of bytes
  <<basic_socket,`basic_socket`>> will copy from message bodies in an attempt to
  send a single buffer chunk to the underlying network write syscall. If `0`,
...
include::ref/basic_poly_socket_base.adoc[]

include::ref/basic_poly_server_socket.adoc[]

include::ref/basic_poly_client_socket.adoc[]

include::ref/basic_poly_socket.adoc[]

include::ref/poly_socket_base.adoc[]

include::ref/poly_server_socket.adoc[]

include::ref/poly_client_socket.adoc[]

include::ref/poly_socket.adoc[]
...
include::ref/client_socket_adaptor.adoc[]

include::ref/socket_adaptor.adoc[]
...
include::ref/poly_socket_header.adoc[]

include::ref/poly_server_socket_header.adoc[]

include::ref/poly_client_socket_header.adoc[]

include::ref/poly_socket_base_header.adoc[]

include::ref/read_state_header.adoc[]

include::ref/server_socket_adaptor_header.adoc[]

include::ref/client_socket_adaptor_header.adoc[]

include::ref/socket_adaptor_header.adoc[]
